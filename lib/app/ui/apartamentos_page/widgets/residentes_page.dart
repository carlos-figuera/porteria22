...
class ResidenteslPage extends StatefulWidget {
  MApartameto  listApartamentos;
  ResidenteslPage({ this.listApartamentos });

  @override
  _ResidenteslPageState createState() => _ResidenteslPageState();
}

class _ResidenteslPageState extends State<ResidenteslPage> {
             ...
             ExcludeSemantics(
              child: Padding(
                ...
                child: TextFormField(
                  onChanged: (dato) {
                    if (dato.length > 0) {
                      _listApa.residents.forEach((lisau) async {
                            ...
                            child:Padding(
                              ...
                              child: Column(
                                children: <Widget>[
                                  textoItems(
                                      name: "Nombre:",
                                      texto: _listApa.residents[position].name),
                                  textoItems(
                                      name: "Edad:", texto: " 21 "),
                                  textoItems(
                                      name: "Propietario:",
